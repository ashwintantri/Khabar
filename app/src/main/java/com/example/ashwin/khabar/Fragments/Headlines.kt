...
class Headlines : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        refreshLayout.setOnRefreshListener {
            HelperFunctions.loadData(rootView, JSON_URL, newsItems, recyclerView, context)
            refreshLayout.isRefreshing = false
        }
        HelperFunctions.loadData(rootView, JSON_URL, newsItems, recyclerView, activity!!.applicationContext)
        return rootView
    }
        private val JSON_URL = "https://newsapi.org/v2/top-headlines?country=in&apiKey=ae072e92b280480c99dc61a7d1f1c9b0"
}
